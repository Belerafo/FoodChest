package com.example.foodchest.bindingadapter
...
import com.example.foodchest.adapter.FavoriteRecipeAdapter
...
class FavoriteRecipesBinding {
    ...
    companion object {
        ...
        @JvmStatic
        fun setVisibility(view: View, favoritesEntity: List<FavoritesEntity>?, mAdapter: FavoriteRecipeAdapter?) {
            when (view) {
                is RecyclerView -> {
